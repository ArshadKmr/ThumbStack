    ...
    return (
        <div className="sticky top-0 z-10">
            <div className="flex text-white justify-between py-2 px-6 md:pl-20 items-center bg-gradient-to-b from-black to-transparent sticky top-0 z-10">
                <div>
                    <img
                        src="/src/assets/TTL landscape logo1-01.png"
                        alt="Logo"
                ...
                <div className="flex space-x-10 items-center">
                    <img className="h-4 w-4 hover:cursor-pointer" src="/src/assets/magnifier.png" alt="Search" />
                    <img className="h-4 w-4 hover:cursor-pointer" src="/src/assets/basket.png" alt="Basket" />
                    <img className="h-4 w-4 hover:cursor-pointer" src="/src/assets/person.png" alt="Person" />
                </div>
            </div>
        </div>
    )
